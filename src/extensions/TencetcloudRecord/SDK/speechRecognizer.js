export default class SpeechRecognizer {
  ...
  async getUrl() {
    ...
    return `${signStr}&signature=${encodeURIComponent(
      this.signCallback(signStr, this.query.secretkey)
    )}`;
  }
...
export class NewCredential {
  ...
  async createQuery() {
    ...
    // 非必填参数
    this.query.hasOwnProperty("voice_format") &&
    ...
    this.query.hasOwnProperty("word_info") &&
      (params["word_info"] = this.query.word_info);
    this.query.hasOwnProperty("vad_silence_time") &&
      (params["vad_silence_time"] = this.query.vad_silence_time);
